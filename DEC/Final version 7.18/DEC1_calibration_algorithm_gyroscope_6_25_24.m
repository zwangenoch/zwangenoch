function [GyroProCalib,CalibTGyroPro]= DEC1_calibration_algorithm_gyroscope_6_25_24(resampled_gyro_readings, ...
...
[PHiDE(1),ThetaDE(1)]= DEC1_accelerometer_phi_theta_7_11_2024(resampled_accel_readings(1,:), resampled_accel_temp(1), ...
...
for i= 2:length(LLdd)
    ...
    [PHiDE(i),ThetaDE(i)]= DEC1_accelerometer_phi_theta_7_11_2024(resampled_accel_readings(i,:), resampled_accel_temp(i), ...
                               xi01, xi901, xi_901, yi01, yi901, yi_901, zi01, zi901, zi_901, ...
                               CalibTAccel, data_flag);
