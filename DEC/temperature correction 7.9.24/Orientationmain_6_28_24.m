function [ThetaDE,FullOrientation,... %BCasing1, BTubing1,
    BCasinOriented, BTubinOriented,Depth_new] = Orientationmain_6_28_24( depth, gyro_readings, Dataace22,...
...
xi_901      = acc_calibration_para(:, 9);
yi01        = acc_calibration_para(:, 4);
yi901       = acc_calibration_para(:, 5);
yi_901      = acc_calibration_para(:, 6);
zi01        = acc_calibration_para(:, 1);
zi901       = acc_calibration_para(:, 2);
zi_901      = acc_calibration_para(:, 3);
...
%% revision by Ze Wang, Jun 27, 2024, flags for adjust highside angle difference when switching to ACC with previous using of ACC and gyro
